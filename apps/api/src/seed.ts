...
async function main() {
  ...
  const scans = [
    ...
    },
    {
      ...
      status: 'complete',
      startedAt: daysAgo(1),
      completedAt: new Date(daysAgo(1).getTime() + 12 * 60_000),
      critical: 0,
      high: 1,
      medium: 0,
      passedGate: false,
    },
    {
      ...
      status: 'complete',
      startedAt: daysAgo(1),
      completedAt: new Date(daysAgo(1).getTime() + 8 * 60_000),
      critical: 1,
      high: 1,
      medium: 1,
      passedGate: false,
  ...
  const findings = [
    {
      ...
      asset: 'payment-service',
      status: 'open',
      fixVersion: 'runc 1.1.12',
      firstSeen: daysAgo(5),
      lastSeen: daysAgo(0),
      scanId: SCAN.sysPayment,
      remediationSteps: [
    ...
    },
    {
      ...
      asset: 'api-gateway',
      status: 'in_progress',
      fixVersion: 'nghttp2 1.57.0',
      firstSeen: daysAgo(6),
      lastSeen: daysAgo(0),
      scanId: SCAN.bdPayment,
      remediationSteps: [
  ...
  const downloads = [
    {
      id: randomUUID(),
      name: `Executive Summary — ${prev} ${yr}`,
      format: 'PDF',
      size: '128 KB',
      createdAt: daysAgo(2),
    },
    {
      id: randomUUID(),
      name: `Full Vulnerability Report — ${prev} ${yr}`,
      format: 'CSV',
      size: '64 KB',
      createdAt: daysAgo(3),
    },
    {
      id: randomUUID(),
      name: `OWASP Compliance Report — ${twoBack} ${yr}`,
      format: 'PDF',
      size: '96 KB',
    ...
    {
      id: randomUUID(),
      name: `Executive Summary — ${twoBack} ${yr}`,
      format: 'PDF',
      size: '112 KB',
